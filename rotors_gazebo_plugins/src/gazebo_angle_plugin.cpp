...
#include "rotors_gazebo_plugins/gazebo_angle_plugin.h"
...
GazeboAnglePlugin::GazeboAnglePlugin(){}
...
void GazeboAnglePlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
...
void GazeboAnglePlugin::OnUpdate(const common::UpdateInfo& _info) {
...
GZ_REGISTER_MODEL_PLUGIN(GazeboAnglePlugins);
}
